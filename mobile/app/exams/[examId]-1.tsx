        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.card}>
            ...
            {/* Same "question is the main event" layout as SegmentQuiz —
                full-width text with no image, or text + a fixed right-side
                thumbnail (contain, never cropped) when there is one. Tapping
                the thumbnail opens it near full-screen — a busy circuit
                diagram with labeled values just isn't legible shrunk down
                to a small corner box. */}
            {q.image_url ? (
